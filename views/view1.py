...
class ATM:
    ...
    def Login(self):
        ...
        #events
        self.loginBut = Button(self.frame,text="LOGIN",bg=self.color1,fg="white")
    ...
    def Details(self, description='string'):
        self.Clear()
        self.frame = Frame(self.master, bg=self.color2, width=600, height=200)
        ...
        self.quitBut.place(x=25, y=10, width=100, height=25)
        self.backBut.place(x=475, y=10, width=100, height=25)
        self.details.place(x=200, y=25, width=200, height=200)
    ...
    def WithdrawOther(self):
        ...
        #create
        self.money_box = Entry(self.frame, bg="honeydew", highlightcolor=self.color1)
        self.submitBut = Button(self.frame, text="Submit", bg=self.color1, fg="white")
        self.quitBut = Button(self.frame, text="Quit", bg=self.color1, fg="white")
        self.backBut = Button(self.frame, text="Back", bg=self.color1, fg="white")
        # place
        self.money_box.place(x=200, y=100, width=200, height=20)
        self.submitBut.place(x=445, y=100, width=55, height=20)
        self.quitBut.place(x=25, y=10, width=100, height=25)
        self.backBut.place(x=475, y=10, width=100, height=25)
    ...
    def Confirm(self, message):
        ...
        self.continueBut = Button(self.frame, text="Continue Banking", bg=self.color1, fg="white")
        self.quitBut = Button(self.frame, text="Quit", bg=self.color1, fg="white")
        # place
        self.text_widget.place(x=100, y=100, width=400, height=40)
